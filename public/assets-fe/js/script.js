...
function buyButtonClicked() {
    // Tampilkan pesan pemberitahuan kepada pengguna
    alert('Masuk ke list pesanan untuk melakukan pemesanan dihalaman dashboard anda');
    ...
    for (var i = 0; i < cartBoxes.length; i++) {
        ...
        var priceValue = parseFloat(price.replace('Rp', '').replace(',', ''));
