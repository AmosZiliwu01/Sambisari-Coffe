...
<div id="wrapper">
    ...
    <ul class="sidebar-dark navbar-nav sidebar accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
            <div class="sidebar-brand-icon">
                <img src="{{asset('assets-fe/images/Icon.png')}}" alt="Logo" style="max-width: 80%; height: auto;">
            </div>
        </a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <!-- Topbar -->
            <nav class="bg-success1 navbar navbar-expand navbar-light topbar mb-4 static-top shadow">
                ...
                <form
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control bg-ungu border-0 small" placeholder="Search for..."
